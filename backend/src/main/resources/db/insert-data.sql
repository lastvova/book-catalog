...
values  (1, 'War and Peace', 2009, 1427038651124, 'Read How You Want'),
        ...
        (12, 'The Shining', null, 3263463463434, 'teff'),
...
values  (1, 'Adam', 'Would absolutely recommend to any Tolkien fan or fan of fantasy/literature in general.', 5, 8),
        (2, 'Demonsub', 'It’s by far my favourite book of the year so far and I certainly look forward to rereading it in years to come.', 5, 7),
...
Integer tempor, turpis id vulputate posuere, velit risus mollis mauris, eget gravida risus magna quis mauris. Etiam ullamcorper at velit eu fringilla. Morbi facilisis porta nisl eget ultrices. Fusce a enim sed mauris tempor suscipit. Quisque viverra faucibus justo ut porttitor. Nam tellus augue, pellentesque sit amet erat eget, lacinia molestie felis. Sed suscipit augue quam, ut venenatis elit lacinia at. Nunc ultrices ipsum metus. Donec ac felis feugiat, accumsan purus at, dictum quam.', 4, 4),
        (18, 'Pit', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using ''Content here, content here'', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for ''lorem ipsum'' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).', 5, 4),
...
Note: The rest of this review has been withheld due to the changes in Goodreads policy and enforcement. You can read why I came to this decision', 3, 4),
...
If you''ve already read Boneshaker, just go ahead to Dreadnought and don''t worry about this one unless you just can''t get enough of The Clockwork Century.', 5, 5),
...
I liked the characters, even if they were a little shallow. They had heart.', 5, 5),
        (23, 'Brick', 'My sister read and wrote a review of Clementine before I got to it, so I noticed things that she mentioned in her review that I wouldn''t normally notice: It was a fast-paced book; it lacked the sharing of background and history that Boneshaker had; it could probably be called more superficial. But I don''t mind. Sometimes, a slow, leisurely exploration of a new place or culture or universe is enjoyable, the way curling up in front of the fire with a cup of hot chocolate and a book on a snowy winter afternoon is enjoyable. But Clementine is not fire and cocoa and book on a snowy day; Clementine is more like when we were kids driving with my dad, and he would take the corners as fast as he dared (which ended up never being more than the speed limit, apparently), pressing us all against doors or floating us into the space between seats, suspended in the middle of things (depending on which side of the car we were on). Clementine is brief and maybe lacking depth, but that doesn''t make it less fun.', 4, 5),
        (24, 'Carnegie', 'This is one of the best thrillers I''ve ever read! The characters are very well-developed. Good people doing good things for good reasons. This was a great read, which I thoroughly enjoyed and will certainly read this author again. Felt like the tech in this book was reaching for Brett Arquette''s technothrillers.', 4, 10),
        (25, 'Jane', 'CHAPTER 1
...
I am just wishing that this book will be better than The Lost Symbol.. That one was a major fail of the series.. Hope it''ll be amazing..', 4, 10),
...
I''m not a Brown hater, but I have to wonder what Dante''s Inferno would have looked like in the hands of Umberto Eco.', 3, 10),
...
Would I recommend this to anyone? Not really. There''s nothing to see here so I would encourage you to keep it moving.', 1, 10),
        (30, 'Jason', 'To all the folks who rate a book before they''ve read it, skewing the ratings for everyone...go to Amazon with all the other flamers. Leave our ratings alone.', 3, 10),
...
Note that as of writing this, the second and third books in Trade Paperback size on Amazon are both $9.99 each (same price as the NEW MMP books) but God Emperor is almost full price at $16.99 for some reason.', 5, 14),
